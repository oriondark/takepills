...
export default class Pharma extends Component {
  ...
  */   
  ...
  //var Pharmacy = this.props.navigation.state.params.item;
   // console.log(this.state.Pharmacy);
            ...
            <Container>
              ...
              <View style={styles.itemContainer}>
                <View style={styles.infoContainer}>
                  ...
                  <Text>
                    <Image style={{ width: 100, height: 100 }} source={this.props.navigation.state.params.item.image} />
                  </Text>
                  <Text>  {this.props.navigation.state.params.item.street}</Text>
                  <Text> {this.props.navigation.state.params.item.city} , {this.props.navigation.state.params.item.postcode}</Text>
                  <Text> {this.props.navigation.state.params.item.phone}
                  </Text>
